...
def process_form(value):
    ...
    apim_key = "cddf8ef3ed804609adea775dfdbc94fd"
    #Insert the ID for the form recognizer model
    model_id = "b0413f03-8265-43e1-8504-aee64fca300f"
    post_url = endpoint + "/formrecognizer/v2.0/custom/models/%s/analyze" % model_id
    #Azure storage connection string where files will be uploaded
    connectionstring = "DefaultEndpointsProtocol=https;AccountName=asastoresynp0305;AccountKey=VKHPaVgqFHum1AhBHhVRKjYdqNLskhnOupUKUsoX22WdmI5n2W0jxdGF60iv0yOZXnXC6R3EunIx+ASt5eDPDQ==;EndpointSuffix=core.windows.net"
    # <<DefaultEndpointsProtocol=https;AccountName=asastore{{synp0305}};AccountKey=key;EndpointSuffix=core.windows.net>>"
